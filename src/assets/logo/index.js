export const CatLogoOne = ({ height, width, className }) => {
    return (
        <svg
            className={className}
            height={height}
        ...
        >
            <defs>
                ...
                >
                    ...
                    <stop offset="0.23" stopColor="aqua" />
...
export const LogoTwo = ({ src, height, width, className, ...props }) => {
    return <img src={src} alt="" className={className} height={height} width={width} {...props} />;
};

export const Logo = ({ height, width, className }) => {
    return (
        <svg
            className={className}
            height={height}
        ...
        >
            ...
            />
            <path
                d="M1042.9,380.3v13.2a5.16,5.16,0,0,1-5.2,5.2H974.8c0,3.3.1,6.2.1,8.9a480,480,0,0,1-2.7,53.3,5.19,5.19,0,0,1-5.1,4.7H953.5a4.84,4.84,0,0,1-3.6-1.6,4.75,4.75,0,0,1-1.2-3.8,470.56,470.56,0,0,0,2.8-52.6c0-2.8,0-5.7-.1-8.9H889.2a5.16,5.16,0,0,1-5.2-5.2V380.3a5.16,5.16,0,0,1,5.2-5.2h61.3a460.85,460.85,0,0,0-8.1-63.2,4.6,4.6,0,0,1,.9-3.6,4.22,4.22,0,0,1,3.3-1.6h14.7a4.81,4.81,0,0,1,4.7,3.9,507.25,507.25,0,0,1,8,64.5h63.7A5.29,5.29,0,0,1,1042.9,380.3Z"
                fill="#fff"
            />
            <path
                d="M202.2,206h-.1m-.7.1c-.3,0-.6-.1-.9-.1a2.77,2.77,0,0,0,.9.1h0Zm0,0c-.3,0-.6-.1-.9-.1a2.77,2.77,0,0,0,.9.1h0Z"
                fill="none"
            />
            <path
                d="M957.3,275.6a438.92,438.92,0,0,0-771.9-78,5.12,5.12,0,0,0-.6,4.5,4.88,4.88,0,0,0,3.2,3.2l11.4,3.9a7.47,7.47,0,0,0,2,.3,6.59,6.59,0,0,0,5.3-2.8A415.52,415.52,0,0,1,550.6,24.5,416.08,416.08,0,0,1,933.7,278.4a6,6,0,0,0,5.5,3.7h13.6a4.58,4.58,0,0,0,3.9-2.1A4.38,4.38,0,0,0,957.3,275.6ZM201.4,206.1a2.92,2.92,0,0,1-.9-.2,2.92,2.92,0,0,0,.9.2h0Zm735,74.2a4.05,4.05,0,0,0,.9.5C937,280.6,936.7,280.5,936.4,280.3Z"
                fill="url(#radial-gradient)"
            />
        </svg>
    );
...
export const Home = ({ className, height, width }) => {
    return (
        <svg
            className={className}
            height={height}
...
export const WatchList = ({ className }) => {
    return (
        <svg
            className={className}
            alt=""
        ...
        >
            <path d="M27.85 15.1H20.9V8.15a2.9 2.9 0 0 0-5.8 0v6.95H8.15a2.9 2.9 0 0 0 0 5.8h6.95v6.95a2.9 2.9 0 0 0 5.8 0V20.9h6.95a2.9 2.9 0 1 0 0-5.8z"></path>
        </svg>
    );
};

export const Original = ({ className }) => {
    return (
        <svg
            className={className}
            alt=""
